...
public class BlockRenderAllocator {
    ...
    private static boolean isFaceOccludedByState(BlockGetter level, Direction face, float height, BlockPos pos, BlockState state) {
        if (state.canOcclude()) {
            VoxelShape voxelshape = Shapes.box((double)0.0F, (double)0.0F, (double)0.0F, (double)1.0F, (double)height, (double)1.0F);
    ...
    public void renderLiquid(PoseStack poseStack, BlockAndTintGetter level, BlockPos pos, VertexConsumer buffer, BlockState blockState, FluidState fluidState) {
        ...
        if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
            ...
            if (flag1 && !isFaceOccludedByNeighbor(level, pos, Direction.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
                ...
                float f29 = f4 * f1;
                float f30 = f4 * f2;
                this.vertex(buffer, poseStack, f36 + 0.0F, f37 + f8, f38 + 0.0F, f57, f29, f30, alpha, f17, f21, l);
                this.vertex(buffer, poseStack, f36 + 0.0F, f37 + f10, f38 + 1.0F, f57, f29, f30, alpha, f18, f22, l);
                this.vertex(buffer, poseStack, f36 + 1.0F, f37 + f9, f38 + 1.0F, f57, f29, f30, alpha, f19, f23, l);
                this.vertex(buffer, poseStack, f36 + 1.0F, f37 + f7, f38 + 0.0F, f57, f29, f30, alpha, f20, f24, l);
            ...
            if (flag2) {
                ...
                float f48 = f3 * f1;
                float f50 = f3 * f2;
                this.vertex(buffer, poseStack, f36, f37 + f16, f38 + 1.0F, f46, f48, f50, alpha, f40, f43, k);
                this.vertex(buffer, poseStack, f36, f37 + f16, f38, f46, f48, f50, alpha, f40, f42, k);
                this.vertex(buffer, poseStack, f36 + 1.0F, f37 + f16, f38, f46, f48, f50, alpha, f41, f42, k);
                this.vertex(buffer, poseStack, f36 + 1.0F, f37 + f16, f38 + 1.0F, f46, f48, f50, alpha, f41, f43, k);
            }
            ...
            for(Direction direction : Direction.Plane.HORIZONTAL) {
                ...
                if (flag7 && !isFaceOccludedByNeighbor(level, pos, direction, Math.max(f44, f45), level.getBlockState(pos.relative(direction)))) {
                    ...
                    float f34 = f4 * f32 * f1;
                    float f35 = f4 * f32 * f2;
                    this.vertex(buffer, poseStack, f47, f37 + f44, f49, f33, f34, f35, alpha, f56, f59, j);
                    this.vertex(buffer, poseStack, f51, f37 + f45, f52, f33, f34, f35, alpha, f58, f60, j);
                    this.vertex(buffer, poseStack, f51, f37 + f16, f52, f33, f34, f35, alpha, f58, f31, j);
                    this.vertex(buffer, poseStack, f47, f37 + f16, f49, f33, f34, f35, alpha, f56, f31, j);
    ...
    private void vertex(
        ...
        p_110985_.addVertex(poseStack.last(), p_110989_, p_110990_, p_110991_)
